-- Partial availability includes completely available people (>= required) as well as
-- those between 75% of required and fully available.
...
AS $$
    ...
    WHERE
        CASE lower(COALESCE(p_availability, 'everyone'))
            ...
            WHEN 'partial' THEN w.avg_availability >= (par.required_percent * 0.75)
            ELSE TRUE
        END
