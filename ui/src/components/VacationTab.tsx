      ...
      <div className="app-card p-5" id="vacation-filter-section">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="relative">
            <label className="block text-[10px] font-bold text-tertiary uppercase tracking-wide mb-1.5">
              Search Team Member
            </label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full text-xs bg-input border border-default rounded-lg pl-9 pr-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 transition text-primary"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full text-xs bg-input border border-default rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 transition cursor-pointer font-medium text-primary"
            >
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-slate-800/60 text-sm">
              {filteredVacations.length === 0 ? (
                ...
                filteredVacations.map((v) => {
                  ...
                  return (
                    <tr key={v.id} className="hover:bg-surface-muted/50 transition-colors" id={`vacation-row-${v.id}`}>
                      {/* Resource details */}
                      ...
                      <td className="px-6 py-4">
                        <span className="inline-flex items-center text-xs font-medium text-secondary bg-surface-muted px-2.5 py-1 rounded-md">
                          <Briefcase className="w-3.5 h-3.5 text-tertiary mr-1" />
